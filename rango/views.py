...
def about(request):
    ...
    context_dict = {'boldmessage': 'This tutorial has been put together by Zainab Meerza'}
...
def show_category(request,category_name_slug):
    ...
    try:
        # Can we find a category name slig with the given name?
        ...
        # Adds our results list to the template context under namee pages.
        context_dict['pages'] = pages
        # We also add the category object from
        # the database to the context dictionary.
        # We'll use this in thhe template to verify that the category exists.
